...
df_clean <- glass[-outlier_indexes,]
```
...
```{r}
# pca <- PCA(df_cat_clean, scale = TRUE, quali.sup = 8:10, graph=F)
 pca <- PCA(df_clean, scale = TRUE, quali.sup = 10, graph=F)
```
